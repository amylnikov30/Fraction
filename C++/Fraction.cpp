...
Fraction::Fraction(float numerator, float denominator, Symbol symbol)
{
...
Fraction* Fraction::FromString(std::string input)
{
    ...
    if (piPosition != -1)
    {
        ...
        return new Fraction(std::stof(s_numerator) * PI, std::stof(s_denominator), Symbol::pi);
    }
